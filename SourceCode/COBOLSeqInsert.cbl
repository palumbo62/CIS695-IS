       ...
       AUTHOR. Michael Coughlan with changes by Jon Clark.
      ...
      * - Students.New - which contains the inserted records.
       ...
       SELECT StudentRecords ASSIGN TO "C:\Users\clarkjd\STUDENTSseq.DAT"
             ORGANIZATION IS LINE SEQUENTIAL
             ACCESS MODE IS SEQUENTIAL.

       SELECT TransRecords ASSIGN TO "C:\Users\clarkjd\TRANSINSseq.DAT"
             ORGANIZATION IS LINE SEQUENTIAL
             ACCESS MODE IS SEQUENTIAL.

       SELECT NewStudentRecords ASSIGN TO "C:\Users\clarkjd\STUDENTSseq.NEW"
             ORGANIZATION IS LINE SEQUENTIAL
             ACCESS MODE IS SEQUENTIAL.
